...
expected_negative=3
echo "COVERAGE fifo_async_mem positive_matrix=${positive_count}/${expected_positive} data_widths=${data_widths[*]} depths=${depths[*]} negative_cases=${negative_count}/${expected_negative}"
echo "PASS fifo_async_mem T008 regression"
